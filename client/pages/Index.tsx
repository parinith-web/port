...
export default function Index() {
  return (
    <div className="mx-auto max-w-[1280px] px-6 pb-20 pt-10 sm:px-10 lg:px-[73px] lg:pt-6">
      <section className="flex flex-col-reverse items-center gap-10 lg:flex-row lg:items-center lg:justify-between lg:gap-16">
        <div className="flex w-full flex-col items-start gap-8 lg:max-w-[472px]">
          ...
          <p className="text-sm font-bold uppercase leading-6 tracking-[1.6px] text-white sm:text-base">
        ...
        <img
          ...
          alt="Parinith Reddy"
          className="w-full max-w-[260px] sm:max-w-[320px] lg:w-[388px] lg:max-w-[388px]"
        />
      </section>

      <div className="mt-14 flex flex-col gap-10 lg:mt-16 lg:flex-row lg:items-start lg:justify-between">
        <p className="max-w-[614px] text-base capitalize leading-normal text-white">
